...
cp /Volumes/CM9/cm10/out/target/product/d2att/system/lib/hw/lights.msm8960.so ../packaging/Bootv2/system/lib/hw

cp arch/arm/boot/zImage ../packaging/staging

cp -R ../../CM9/cm10/out/target/product/d2att/root/* ../packaging/staging/initramfs
