...
static unsigned int TwTs_Threshold[8] = {250, 0, 140, 250, 140, 190, 0, 190};
...
twts_threshold_x = time threshold, this amount of time must have passed for the related
				   action to be taken (hot/unplug)
