...
static struct __cpuinitdata input_handler mpdec_input_handler = {
...
static ssize_t __cpuinit store_min_cpus(struct kobject *a, struct attribute *b,
                   const char *buf, size_t count)
{
    unsigned int input;
    int ret, cpu;
...
static ssize_t __cpuinit store_enabled(struct kobject *a, struct attribute *b,
                   const char *buf, size_t count)
{
