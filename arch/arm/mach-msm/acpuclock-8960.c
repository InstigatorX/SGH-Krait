...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[4]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 3 },
	[5]  = { {  594000, HFPLL, 1, 0x16 }, 1050000, 1050000, 3 },
	[6]  = { {  648000, HFPLL, 1, 0x18 }, 1050000, 1050000, 4 },
	[7]  = { {  702000, HFPLL, 1, 0x1A }, 1050000, 1050000, 4 },
	[8]  = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1150000, 4 },
	[9]  = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1150000, 5 },
	[10] = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1150000, 5 },
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(11), 1100000 },
	...
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(16), 1200000, AVS(0x400015) },
	...
	{ 1, {  1404000, HFPLL, 1, 0x34 }, L2(20), 1237500, AVS(0x400015) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(20), 1237500, AVS(0x100018) },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(20), 1250000, AVS(0x400012) },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(20), 1250000, },
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(20), 1275000, },
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(20), 1300000, },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(20), 1400000, },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(11), 1050000 },
	...
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(16), 1150000, AVS(0x400015) },
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(11), 1000000 },
	...
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(16), 1100000, AVS(0x10001B) },
