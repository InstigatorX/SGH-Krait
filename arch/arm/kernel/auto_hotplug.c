 ...
 */
#define DEFAULT_MIN_SAMPLING_RATE	100
 ...
 */
#define DEFAULT_ENABLE_ALL_LOAD_THRESHOLD	(200 * CPUS_AVAILABLE)
#define DEFAULT_ENABLE_LOAD_THRESHOLD		400
#define DEFAULT_DISABLE_LOAD_THRESHOLD		120
...
MODULE_PARM_DESC(min_sampling_rate, "auto_hotplug minimum sampling rate (10-200ms)");
